...
public class SPParts {
    ...
    public static final ItemDefinition<PartItem<ProbabilityPatternTerminalPart>> PROBABILITY_PATTERN_TERMINAL_PART = createPart("Probability Pattern Terminal Part", ItemIds.PROBABILITY_PATTERN_TERMINAL, ProbabilityPatternTerminalPart.class, ProbabilityPatternTerminalPart::new);
